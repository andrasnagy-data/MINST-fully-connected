...
*Note* During this project, I learned about data sets (dataset class for deep learning), data loaders (iterator wrapped around the dataset class), model architecture and training loop (with evaluation).
